    ...
    override func viewDidLoad()
        {
            ...
            colleges.append(University(Name: "Univeristy Of Illinois", Location: "Urbana-Chapaigne, Illinois", Students: 44000, Picture: UIImage(named: "Illinois")!, Webpage: "illinois.edu"))
            colleges.append(University(Name: "Univeristy Of Oregon", Location: "Eugene, Oregon", Students: 24000, Picture: UIImage(named: "Oregon")!, Webpage: "uoregon.edu"))
            colleges.append(University(Name: "Colorado University", Location: "Boulder, Colorado", Students: 30000, Picture: UIImage(named: "Colorado")!, Webpage: "www.colorado.edu"))
        }
